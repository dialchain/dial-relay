...
public class MessageResource {
    ...
    public String receive(
        ...
        log.debug("Get message: Sender [{}], Recipient [{}], MessageId [{}]", sender, recipient, messageId);
    ...
    public Map<String, String> receive(
        ...
        log.debug("Get messages: Sender [{}], Recipient [{}], MessageId [{}]", sender, recipient, Arrays.toString(messageIds));
    ...
    public Boolean send(
        ...
        final @RequestHeader(value = PROOF_OF_POSSESSION_TIMESTAMP_HEADER,required = false) Instant popTimestamp) {
        log.debug("Sending message: Sender [{}], Recipient [{}], MessageId [{}]", sender, recipient, messageId);
    ...
    public Boolean delete(
        ...
        final @RequestHeader(value = PROOF_OF_POSSESSION_HEADER,required = false) String recipientPopHeader,
        final @RequestHeader(value = PROOF_OF_POSSESSION_TIMESTAMP_HEADER,required = false) Instant popTimestamp) {
        log.debug("Deleting message: Sender [{}], Recipient [{}], MessageId [{}]", sender, recipient, messageId);
        securityService.assertSignature(recipientPopHeader, sender, recipient, messageId, popTimestamp, recipient);
